...
public class YFSonata implements VehicleDataAnalyzer
{
    public YFSonata()
    {
        working = false;
    ...
    public YFSonata(VehicleCommunicator comm)
    {
        this();
                ...
                while(!isInterrupted())
                {
                    ...
                    catch(Exception e)
                    {
                        ...
                        catch(Exception ee)
                        {
                            if(logger != null)
                            {
                                logger.log("[YFSonata] " + ee.toString());
                            }
                    ...
                    if(receivedData != null)
                    {
                        if(logger != null)
                        {
                            ...
                            logger.log("[YFSonata] Received data: "+ rd);
                        }
                        ...
                        */
                        ...
                        else if(dataID.equals(brakeAndAccelID))
                        {
                            final int brakeByteOffset = dataStartIndex + 4;
                            final int accelByteOffset = dataStartIndex + 6;
                            final int maxAccelValue = 0xFE;
                        ...
                        else if(dataID.equals(fuelAndLoadID))
                        {
                        	final int loadByteOffset = dataStartIndex;
                            final int fuelConsumptionByteOffset = dataStartIndex + 1;
                        ...
                        */
                        else if(dataID.equals(convenienceID))
                        {
                            ...
                            */
                            ...
                            final int lightByteOffset = dataStartIndex + 4;
                            final int doorByteOffset = dataStartIndex;

                            if(receivedData.length > lightByteOffset)
                            {
                            	final int doorBitAddr = 6;
                            	
                            	String doorHexaData = receivedData[doorByteOffset];
                            	
                            	byte doorData = (byte)(Byte.parseByte(doorHexaData, hexaRadix) & (1 << doorBitAddr));
                            	
                            	if(doorData == 0)
                            	{
                            		dataContainer.setDoor(VehicleDataContainer.DOOR_CLOSED);
                            	}
                            	else
                            	{
                            		dataContainer.setDoor(VehicleDataContainer.DOOR_OPENED);
                            	}
                            	
                            	final int lightBitAddr = 5;
                            	final int highBeamBitAddr = 6;
                            	
                            	String lightHexaData = receivedData[lightByteOffset];
                            	
                            	byte lightRawData = (byte)(Byte.parseByte(lightHexaData, hexaRadix));
                            	
                            	byte lightLowData = (byte)(lightRawData & (1 << lightBitAddr));
                            	byte lightHighData = (byte)(lightRawData & (1 << highBeamBitAddr));
                            	...
                            	else
                            	{
                            		if(lightLowData != 0)
                            		{
                            			dataContainer.setLight(VehicleDataContainer.LIGHT_ON);
                            		}
                            		else
                            		{
...
*/
    ...
    public void startAnalyze()
    {
        if(logger != null)
        {
            logger.log("[YFSonata] start analyze");
        }
        ...
        if(logger != null)
        {
            logger.log("[YFSonata] start analyze: monitoring thread start");
        }
        ...
        if(logger != null)
        {
            logger.log("[YFSonata] start analyze: interface module ready");
        }

        if(logger != null)
        {
            logger.log("[YFSonata] start analyze: success");
        }
    }
    ...
    public void stopAnalyze()
    {
        if(logger != null)
        {
            logger.log("[YFSonata] stop analyze");
        }
        ...
        if(logger != null)
        {
            logger.log("[YFSonata] stop analyze: monitoring thread interrupted");
        }
        ...
        catch(Exception e)
        {
            if(logger != null)
            {
                logger.log("[YFSonata] " + e.toString());
            }
        }

        if(logger != null)
        {
            logger.log("[YFSonata] stop analyze: monitoring thread joined");
        }

        if(logger != null)
        {
            logger.log("[YFSonata] stop analyze: success");
        }
    }
    ...
    private final String brakeAndAccelID = "329";
    ...
    private final String fuelAndLoadID = "260";
